...
INSERT INTO albuns(album_name, year_album, artists_id)
...
INSERT INTO songs(song_name, duration_seconds, album_id)
...
CREATE TABLE SpotifyClone.users(
   ...
   INSERT INTO users(user_name, year_user, signature_date, plan_id)
...
CREATE TABLE SpotifyClone.followers(
   ...
   FOREIGN KEY (artists_id) REFERENCES artists(artists_id),
   CONSTRAINT PRIMARY KEY(follow_artist_id, artists_id )
) engine = InnoDB;

INSERT INTO followers(user_id, artists_id)
VALUES(1, 1),
(1,	4),
(1,	3),
(2,	1),
...
CREATE TABLE SpotifyClone.reproductions(
    id_reproduction INT AUTO_INCREMENT,
    reproduction_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    song_id INT NOT NULL,
    user_id INT NOT NULL,   
    FOREIGN KEY(song_id) REFERENCES songs(song_id),
	FOREIGN KEY(user_id) REFERENCES users(user_id),
	CONSTRAINT PRIMARY KEY (id_reproduction, user_id)

   ) engine = InnoDB;
   
   INSERT INTO reproductions(reproduction_date, song_id, user_id)
   VALUE('2020-02-28 10:45:55',36, 1),   
